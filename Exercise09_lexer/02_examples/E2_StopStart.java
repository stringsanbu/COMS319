// Generated from E2_StopStart.g4 by ANTLR 4.4
...
public class E2_StopStart extends Lexer {
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		switch (ruleIndex) {
		case 0: COMMAND_action((RuleContext)_localctx, actionIndex); break;
		}
	}
	private void COMMAND_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 0:  System.out.println("Stop command received"); break;
		case 1:  System.out.println("Start command received");  break;
		case 2: System.out.println("other text read: "+getText());  break;
		}
	}
