...
<body>
	...
	<?php
		...
		echo "</td>";
		echo "<td>";
		echo $library->shelf['shelf'.htmlentities($book_loc["shelf"],  ENT_QUOTES,  "utf-8")]->books['book'.htmlentities($book_loc["book"]->bookID)];
		echo "</td>";
		...
		echo "</td>";
		echo "<td>";
		echo $library->shelf['shelf'.htmlentities($book_loc["shelf"],  ENT_QUOTES,  "utf-8")]->books['book'.htmlentities($book_loc["book"]->copyID)];
		echo "</td>";
		...
		echo "</td>";
		echo "<td>";
	echo $library->shelf['shelf'.htmlentities($book_loc["shelf"],  ENT_QUOTES,  "utf-8")]->books['book'.htmlentities($book_loc["book"]->title)];
		echo "</td>";
		...
		echo "</td>";
		echo "<td>";
	echo $library->shelf['shelf'.htmlentities($book_loc["shelf"],  ENT_QUOTES,  "utf-8")]->books['book'.htmlentities($book_loc["book"]->author)];
		echo "</td>";
		...
		if(isset($student))
		{
			...
			{
				echo "<a href=\"book_details.php?shelf=".$book_loc['shelf'].
					"&book=".$book_loc['book']."&return=1\">Return Book</a>";
			}
			else
			{
